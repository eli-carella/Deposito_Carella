...
4. Restiture per ogni giorno se la temperatura è superiore, inferiore, uguale alla media. 
5. Classificare ogni giorno in tre fasce (temperatura normale, molto alta, molto bassa) in base alla deviazione standard
6. Aggiungere scelta di ripetere il programma o uscire
'''
...
while True:
    ...
    #aggiunta scelta di ripezione programma o fine

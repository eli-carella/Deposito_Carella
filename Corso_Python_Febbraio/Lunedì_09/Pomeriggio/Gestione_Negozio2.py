...
class Utente:
    ...
    def compra(self, negozio, nome_articolo, quantita):
        ...
        successo, costo = negozio.vendi(self, nome_articolo, quantita)
        if successo:
...
class Negozio:
        ...
        if articolo in self.inventario and quantita > 0:
            ...
            if self.inventario[articolo]["quantita"] >= quantita:
                ...
                if utente.budget >= costo:
                    # aggiorna utente scalando il budget
                    utente.budget -= costo
    ...
    def report_vendite(self):
        print("\n--- REPORT VENDITE ---")
        # stampa lista vendite: utente articolo quantità totale
    ...
    if scelta == "1":
        ...
        while True:
            ...
            if scelta_cliente == "1":
                ...
                # funzione utente.compra
                utente.compra(negozio, articolo, quantita)
